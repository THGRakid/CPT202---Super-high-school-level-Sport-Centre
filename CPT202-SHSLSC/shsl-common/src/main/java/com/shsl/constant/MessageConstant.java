...
public class MessageConstant {
    ...
    public static final String CODE_ERROR = "Verification code error!";
    public static final String ACCOUNT_ALREADY_EXIST = "You can't delete a locked stadium!";
    public static final String DATA_INTEGRITY_VIOLATION = "Violation of data integrity!";
    public static final String STADIUM_NOT_FIND = "Stadium not found!";
